    ...
    <div className="max-w-5xl mx-auto px-4 py-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center">
          <h1 className="font-playfair text-4xl font-bold text-white mb-4">{product.nom}</h1>
      ...
      {/* Reviews */}
      <div className="mt-20">
        <h2 className="font-playfair text-2xl font-bold text-white mb-8">Avis clients</h2>
