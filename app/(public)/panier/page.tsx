...
export default function Panier() {
  ...
  if (items.length === 0) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-32 text-center">
        <h1 className="font-playfair text-4xl font-bold text-white mb-4">{t(tr.cart_title)}</h1>
        <p className="text-gray-500 mb-8">{t(tr.cart_empty)}</p>
        <Link
          href="/boutique"
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <h1 className="font-playfair text-4xl font-bold text-white mb-10">{t(tr.cart_title)}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            return (
              <div key={item.slug} className="flex items-center gap-4 bg-[#111] border border-[#1f1f1f] rounded-xl p-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-500 text-sm">{item.prix} {t(tr.cart_unit)}</p>
                </div>
        ...
        <div className="bg-[#111] border border-[#1f1f1f] rounded-xl p-6 h-fit sticky top-24">
          <h2 className="font-playfair text-xl font-bold text-white mb-4">{t(tr.cart_summary)}</h2>
          ...
          <div className="flex justify-between text-sm text-gray-400 mb-4">
            ...
            <span className={total() >= 50 ? "text-green-400" : ""}>
              {total() >= 50 ? t(tr.cart_shipping_free) : "4,90 €"}
            </span>
          </div>
