...
function YouTubeBadge() {
  return (
    <span className="inline-flex items-center gap-1.5 bg-[#FF0000] text-white text-[10px] font-bold px-2.5 py-1 rounded-full">
...
function TikTokBadge() {
  return (
    <span className="inline-flex items-center gap-1.5 bg-[#010101] text-white text-[10px] font-bold px-2.5 py-1 rounded-full border border-white/10">
...
function GoogleBadge() {
  return (
    <span className="inline-flex items-center gap-1.5 bg-white text-[#1a1a1a] text-[10px] font-bold px-2.5 py-1 rounded-full">
...
function ClientsBadge() {
  return (
    <span className="inline-flex items-center gap-1.5 bg-[#ff9ed5] text-[#0a0a0a] text-[10px] font-bold px-2.5 py-1 rounded-full">
      <svg className="w-2.5 h-2.5" viewBox="0 0 24 24" fill="currentColor">
