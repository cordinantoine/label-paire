        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div>
            ...
            <input
              ...
              placeholder={t(tr.checkout_name_ph)}
            />
          </div>
          <div>
            ...
            <input
              ...
              className={inputClass}
              placeholder={t(tr.checkout_email_ph)}
            />
          </div>
          <div>
            ...
            <input
              ...
              className={inputClass}
              placeholder={t(tr.checkout_addr_ph)}
            />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={inputClass}
                placeholder={t(tr.checkout_zip_ph)}
              />
            </div>
            <div>
              ...
              <input
                ...
                className={inputClass}
                placeholder={t(tr.checkout_city_ph)}
              />
            </div>
          </div>
