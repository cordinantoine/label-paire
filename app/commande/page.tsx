...
const inputClass = "w-full px-4 py-3 rounded-lg border border-white/10 bg-[#1a1a1a] text-white text-sm focus:outline-none focus:border-[#ff9ed5] placeholder-gray-600";
...
export default function Commande() {
  ...
  if (items.length === 0) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-32 text-center">
        <h1 className="font-playfair text-4xl font-bold text-white mb-4">Commander</h1>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <h1 className="font-playfair text-4xl font-bold text-white mb-10">Commander</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <p className="text-xs text-gray-500 text-center">Paiement sécurisé via Stripe. Vos données sont protégées.</p>
        </form>

        {/* Order summary */}
        <div className="bg-[#111] border border-[#1f1f1f] rounded-xl p-6 h-fit">
          <h2 className="font-playfair text-xl font-bold text-white mb-5">Votre commande</h2>
